...
public class Skill {
	...
	public Skill(String name, SkillGroup group, Descriptor[] descriptors, ImprovementComplexity complexity) {
		this.name = name;
		this.group = group;
	...
	public Skill(String name, SkillGroup group, BaseAttribute[] attributes, Descriptor[] descriptors, ImprovementComplexity complexity) {
		this.name = name;
		this.group = group;
